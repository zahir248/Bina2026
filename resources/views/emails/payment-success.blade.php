...
<head>
    ...
    <style>
        ...
        p { margin: 0 0 12px 0; }
        .highlight { background: #f0fdf4; border-left: 4px solid #22c55e; padding: 12px 16px; margin: 20px 0; border-radius: 0 4px 4px 0; }
...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <p>Attached to this email you will find your <strong>receipt (PDF)</strong> and <strong>QR code image(s)</strong> (one per ticket holder). You can also download them anytime from your <strong>Purchase History</strong> on our website.</p>
