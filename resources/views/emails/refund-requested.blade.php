...
<head>
    ...
    <style>
        ...
        p { margin: 0 0 12px 0; }
        .highlight { background: #eff6ff; border-left: 4px solid #3b82f6; padding: 12px 16px; margin: 20px 0; border-radius: 0 4px 4px 0; }
...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <p>We have received your refund request. It is now <strong>pending review</strong> by our team.</p>
            <div class="highlight">
            ...
            <p>{{ $order->reason }}</p>
            @endif
            <p>We will review your request and notify you of the outcome. Refunds can take 5–10 business days to appear in your account once approved.</p>
            <p>You can check the status of your refund in your <strong>Purchase History</strong> (Refund tab).</p>
