...
<div class="auth-container">
    <div class="auth-card">
        ...
        <form class="auth-form" method="POST" action="{{ route('signup.store') }}">
            @csrf
            <div class="form-group">
                <label for="username" class="form-label">Username <span class="required-asterisk">*</span></label>
                <input type="text" id="username" name="username" class="form-input" placeholder="Enter your username" value="{{ old('username') }}" required>
            </div>
            ...
            <a href="{{ route('signup.google') }}" class="btn-auth-google" aria-label="Continue with Google">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Success toast redirect (only for signup success)
    const messageToast = document.getElementById('message-toast');
    if (messageToast && messageToast.classList.contains('toast-success')) {
